...
public class CameraActivityFragment extends android.app.Fragment
     ...
     */
    private static final String TAG = "CameraActivityFragment";
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT && frontOrBack == BACK ) {
                    continue;
                } else if (facing != null && facing == CameraCharacteristics.LENS_FACING_BACK && frontOrBack == FRONT)
                {
                    continue;
                }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Log.d("Photo file failed", "There was a problem saving the photo...");
    ...
    private void captureStillPicture() {
        ...
        intent.putExtra("Path", activity.getCurrentPhotoPath());
        intent.putExtra("Uri", activity.getCapturedImageURI().toString());
...
//todo figure out why the camera doesnt reload for second picture
    /**
